    ...
    <div className="row">
      ...
      <div className="col-">
        ...
        <span className="input-group-text">
          <FontAwesomeIcon icon={faUsers} size="lg" style={{color: "#012541",}} />
        </span>
        ...
        <MDBInputGroup className='mb-3' >
        <span className="input-group-text">
          <FontAwesomeIcon icon={faPhone} size="lg" style={{color: "#012541",}} />
        </span>
        ...
        <MDBInputGroup className='mb-3' >
        <span className="input-group-text">
          <FontAwesomeIcon icon={faHouse} size="lg" style={{color: "#012541",}} />
        </span>
