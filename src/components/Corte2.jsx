...
<div className='container' style={{ marginLeft: '15px', marginBottom: '50px', marginTop: '50px', textAlign: 'left' }}>
    {nombreEmpleado && (
        <h3 className='h3-clientes'>
            <FontAwesomeIcon icon={faUser} style={{ color: '#52251f', marginRight: '8px' }} />
    ...
    {mostrarVentaUsuario ? (
        <h3 className='h3-clientes'>
            <FontAwesomeIcon icon={faDollar} style={{ color: '#52251f', marginRight: '8px' }} />
    ...
    {ganancia > 0 ? (
        <h3 className='h3-clientes'>
            <FontAwesomeIcon icon={faChartSimple} style={{ color: '#52251f', marginRight: '8px' }} />
    ...
    {mostrarFondoCaja && (
        <h3 className='h3-clientes'>
            <FontAwesomeIcon icon={faCashRegister} style={{ color: '#52251f', marginRight: '8px' }} />
...
<></>
      ...
      <div className='container-fluid'>
        <div className='row'>
          <div className='col'>
            <h3 className='h3-clientes'><FontAwesomeIcon icon={faSackDollar} style={{color: "#52251f"}} ></FontAwesomeIcon> VENTAS: </h3>
  ...
  <div className='col'>
    ...
    <h3 className='h3-clientes'>
      <FontAwesomeIcon icon={faTags} style={{ color: "#52251f" }} /> VENTAS POR DEPARTAMENTOS:</h3>
    <div className="container table">
      <Table striped bordered hover className='table-primary'>
        <thead className='custom-table-header'>
          <tr>
  ...
  <div className='row'>
    <div className='col'>
      ...
      <h3 className='h3-clientes'><FontAwesomeIcon icon={faChartSimple} style={{ color: "#52251f" }} /> GANANCIA POR DEPARTAMENTO:</h3>
      <div className="container table">
        <Table striped bordered hover className='table-primary'>
          <thead className='custom-table-header'>
            <tr>
    ...
    <div className='col'>
      <h3 className='h3-clientes'>
        <FontAwesomeIcon icon={faUsers} style={{ color: "#52251f" }} /> CLIENTES CON MAS VENTAS:</h3>
      <div className="container table">
        <Table striped bordered hover className='table-primary'>
          <thead className='custom-table-header'>
            <tr>
...
<hr />  
    ...
    <h3 className='h3-clientes'>
      <FontAwesomeIcon icon={faTags} style={{ color: "#52251f" }} />
...
: <></>
        ...
        <hr />    
          <div className='col'>
          <h3 className='h3-clientes'><FontAwesomeIcon icon={faArrowUpFromBracket} rotation={180}  style={{color: "#52251f",}}></FontAwesomeIcon> ENTRADA DE EFECTIVO DEL DIA:</h3>
            <div className="container table">
                <Table striped bordered hover className='table-primary'>
                    <thead className='custom-table-header'>
                        <tr>
          ...
          <div className='col'> 
          <h3 className='h3-clientes'><FontAwesomeIcon icon={faArrowUpFromBracket}  style={{color: "#52251f"}}></FontAwesomeIcon> SALIDA DE EFECTIVO DEL DIA:</h3>
            <div className="container table">
                <Table striped bordered hover className='table-primary'>
                    <thead className='custom-table-header'> 
                        <tr>
      ...
      {tablaIngresoUsuario && (     
          <div className='row'>
            <div className='col'>
            <h3 className='h3-clientes'><FontAwesomeIcon icon={faArrowUpFromBracket} style={{color: "#52251f"}} rotation={180}></FontAwesomeIcon> ENTRADA DE EFECTIVO DE USUARIO: {nombreEmpleado}</h3>
            <div className="container table">
                <Table striped bordered hover className='table-primary'>
                    <thead className='custom-table-header'>
                        <tr>
           ...
           <div className='col'>
            <h3 className='h3-clientes'><FontAwesomeIcon style={{color: "#52251f"}} icon={faArrowUpFromBracket}></FontAwesomeIcon> SALIDA DE EFECTIVO DE USUARIO: {nombreEmpleado}</h3>
            <div className="container table">
            <Table striped bordered hover className='table-primary'>
                  <thead className='custom-table-header'>
                      <tr>
...
{ventaEliminada ? 
<>
  <h3 className='h3-clientes'><FontAwesomeIcon style={{color: "#52251f"}} icon={faArrowUpFromBracket}></FontAwesomeIcon> VENTAS ELIMINADAS</h3>
 <div className="container table">
                <Table striped bordered hover className='table-primary'>
                    <thead className='custom-table-header'>
                        <tr>
...
<>
<hr />
  <h3 className='h3-clientes'><FontAwesomeIcon style={{color: "#52251f"}} icon={faArrowUpFromBracket}></FontAwesomeIcon> PAGOS CREDITOS</h3>
 <div className="container table">
                <Table striped bordered hover className='table-primary'>
                    <thead className='custom-table-header'>
                        <tr>
...
<hr />
<h3 className='h3-clientes'>
      <FontAwesomeIcon icon={faTags} style={{ color: "#52251f" }} /> PRODUCTOS ELIMINADOS:</h3>
    <div className="container table">
      <Table striped bordered hover className='table-primary'>
        <thead className='custom-table-header'>
          <tr>
