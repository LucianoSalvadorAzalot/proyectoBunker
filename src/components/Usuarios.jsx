    ...
    <div className="h3-ventas">
     ...
     <div className="container">
       ...
       <span className="input-group-text">
                        <FontAwesomeIcon icon={faUser} size="lg" style={{color: "#012541",}} />
                </span>
          ...
          <MDBInputGroup className='mb-3' >
          <span className="input-group-text">
                        <FontAwesomeIcon icon={faLock} size="lg" style={{color: "#012541",}} />
                </span>
          ...
          <MDBInputGroup>
          <span className="input-group-text">
                        <FontAwesomeIcon icon={faUserGear} size="lg" style={{color: "#012541",}} />
                </span>
