        ...
        <h1>STOCK</h1>
           ...
           <h2><strong>ADMINISTRACION DE STOCK</strong></h2>
            ...
            <div className='container'>
                <div className="row">
                    <div className="col">
                        ...
                        <MDBInputGroup>
                        <span className="input-group-text">
                            <FontAwesomeIcon icon={faShop} size="lg" style={{color: "#012541",}} />
                        </span>
                        ...
                        <option value="1" >Av Avellaneda - 99</option>
                        <option value="2" >San Martin - 16</option>
            ...
            <div className='card-footer text-muted'>
                ...
                <div className='container'>
            <h2 style={{marginTop: '60px'}}>STOCK DE PRODUCTOS SUCURSAL - Entre rios - 213</h2>
            <MDBInputGroup>
            <span className="input-group-text">
                        <FontAwesomeIcon icon={faMagnifyingGlass} size="lg" style={{color: "#012541",}} />
                    </span>
...
<hr />
            ...
            <h2 style={{marginTop: '60px'}}>STOCK DE PRODUCTOS SUCURSAL - San martin 16</h2>
            <MDBInputGroup>
            <span className="input-group-text">
                        <FontAwesomeIcon icon={faMagnifyingGlass} size="lg" style={{color: "#012541",}} />
                    </span>
            ...
            <table className="table table-striped table-hover mt-5 shadow-lg">
                ...
                <tbody>
                    {resultado2.slice(primerIndex2, ultimoIndex2).map((val) => (
                        <tr key={val.Id_stock}>
                            <td>{val.Id_producto}</td>
                            <td>{val.nombre_producto}</td>
                            <td>{val.descripcion_producto}</td>
