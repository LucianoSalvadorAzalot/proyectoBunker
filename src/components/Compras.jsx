  ...
  <App/>
    ...
    <div className="container-fluid"><br />
      ...
      <div className='container'>
          ...
          <MDBInputGroup className='mb-3' >
          <span className="input-group-text">
                        <FontAwesomeIcon icon={faPerson} size="lg" style={{color: "#012541",}} />
                </span>
          ...
          {/* <MDBInputGroup className='mb-3' >
          <span className="input-group-text">
                        <FontAwesomeIcon icon={faPersonWalking} size="lg" style={{color: "#012541",}} />
                </span>
        ...
        <MDBInputGroup className='mb-3'>
              <span className="input-group-text">
                <FontAwesomeIcon icon={faCalendarAlt} size="lg" style={{ color: "#012541" }} />
              </span>
              <DatePicker
          ...
          <MDBInputGroup className='mb-3'>
          <span className="input-group-text">
                        <FontAwesomeIcon icon={faTruck} size="lg" style={{color: "#012541",}} />
                </span>
