...
import logoticket from '../assets/logo-deco.jpg'
...
return (
      ...
      <div className='container-fluid'>
            <div className='row'>
            <div className='col'>
            <h1 style={{textAlign: 'center', marginTop: '50px' }}>DECO ARTESANIAS</h1>  
                <ContenedorBotones style={{marginTop: '50px'}}> 
                <Button variant="dark" onClick={handleShowModal8}>
                    <Badge badgeContent={listaCompras.length} color="secondary">
                    F10-PRODUCTOS <img src={carrito} alt="carrito" style={{ width: '25px', height: 'auto', marginLeft: "7px" }}/>
                    </Badge>
                </Button>
                <Button variant="dark" onClick={handleShowModal11}>
                    <Badge badgeContent={listaCompras.length} color="secondary">
                    F-1 PROMOS <img src={carrito} alt="carrito" style={{ width: '25px', height: 'auto', marginLeft: "7px" }}/>
                    </Badge>
                </Button>
                 </ContenedorBotones> 
            </div>
       ...
       <br />
          ...
          <input type="number" placeholder='$0.00' className='form-control' onChange={(e) => setDescUnidad(e.target.value)} />
          <br/> 
          </>
          :
          <> 
...
<h3 style ={{color: '#A44A3F', textAlign: 'end', marginRight: '100px' }}><strong>SUBTOTAL: {formatCurrency(calcularTotal())}</strong></h3>
