    ...
    return (
        <>
            ...
            <div className="container">
               ...
               <MDBInputGroup className="mb-3">
                    <span className="input-group-text">
                        <FontAwesomeIcon icon={faBalanceScale} size="lg" style={{color: "#012541",}} />
                    </span>
                ...
                <MDBInputGroup className="mb-3">
                    <span className="input-group-text">
                        <FontAwesomeIcon icon={faCalendar} size="lg" style={{ color: "#012541", }} />
                    </span>
                    <input
                ...
                <MDBInputGroup>
                    <span className="input-group-text">
                        <FontAwesomeIcon icon={faScaleBalanced} size="lg" style={{color: "#012541",}} />
                    </span>
